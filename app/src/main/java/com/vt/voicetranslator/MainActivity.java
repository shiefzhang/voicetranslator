...
public final class MainActivity extends Activity {
    ...
    private ClickableSpan rowSelector(int targetPage,String key){return new ClickableSpan(){public void onClick(View widget){focusedKeys[targetPage]=key;scrollSelectionRequested[targetPage]=true;if(prefs.getBoolean(TTS_ENABLED,false)){String[] e=history.get(targetPage).get(key);if(e!=null)speak(e[1],targetPage);}update();}public void updateDrawState(TextPaint paint){paint.setColor(ink);paint.setUnderlineText(false);}};}
