...
public final class MainActivity extends Activity {
    ...
    private ClickableSpan rowSelector(int targetPage,String key,String spoken){return new ClickableSpan(){public void onClick(View widget){focusedKeys[targetPage]=key;scrollSelectionRequested[targetPage]=true;if(prefs.getBoolean(TTS_ENABLED,false))speak(spoken,targetPage);update();}public void updateDrawState(TextPaint paint){paint.setColor(ink);paint.setUnderlineText(false);}};}
